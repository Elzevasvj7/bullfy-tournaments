...
export function mapProfileDashboard(
  ...
  return {
    trader: {
      ...
      avatar3dUrl: dto.trader.avatar_3d_url ?? null,
      avatarConfig: dto.trader.avatar_config ?? null,
      avatarProvider: dto.trader.avatar_provider ?? null,
      avaturnUserId: dto.trader.avaturn_user_id ?? null,
      avaturnAvatarId: dto.trader.avaturn_avatar_id ?? null,
      preferredPose: dto.trader.preferred_pose ?? "idle",
