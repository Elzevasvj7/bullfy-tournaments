...
export const MagicLinkEmail = ({ siteName, confirmationUrl }: MagicLinkEmailProps) => (
  <Html lang="es" dir="ltr">
    <Head />
    <Preview>Tu enlace de acceso a Bullfy IB System</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Text style={text}>Haz click en el botón para iniciar sesión. Este enlace expirará pronto.</Text>
          <Button style={button} href={confirmationUrl}>Iniciar Sesión</Button>
          <Text style={smallText}>Si no solicitaste este enlace, puedes ignorar este email.</Text>
        </Section>
