...
export const InviteEmail = ({ siteName, siteUrl, confirmationUrl }: InviteEmailProps) => (
  <Html lang="es" dir="ltr">
    <Head />
    <Preview>Has sido invitado a Bullfy IB System</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Text style={text}>
            ...
            <Link href={siteUrl} style={link}><strong>Bullfy IB System</strong></Link>.
            Haz click en el botón para aceptar la invitación y crear tu cuenta.
          </Text>
          <Button style={button} href={confirmationUrl}>Aceptar Invitación</Button>
          <Text style={smallText}>Si no esperabas esta invitación, puedes ignorar este email.</Text>
        </Section>
